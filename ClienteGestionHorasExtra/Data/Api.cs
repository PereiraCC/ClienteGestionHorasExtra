...
namespace ClienteGestionHorasExtra.Data
{
    public class Api
    {
        ...
        public List<ModelFormularioAvalado> ObtenerFormulariosAvaladosPendientes(string email, string Base2)
        {
            try
            {
                List<ModelFormularioAvalado> lista = null;
        ...
        public List<ModelFormularioTiempo> ObtenerFormulariosTiempo(string email, string Base2)
        {
            try
            {
                List<ModelFormularioTiempo> lista = null;
                ...
                using (var client = new HttpClient())
                {
                    ...
                    else
                    {
                        ...
                        string mens = task2.Result;
                        lista = JsonConvert.DeserializeObject<List<ModelFormularioTiempo>>(mens);
